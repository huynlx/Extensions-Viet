...
class Truyengihot extends paperback_extensions_common_1.Source {
    ...
    getMangaDetails(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let desc = $(".product-synopsis-content").html().replace(/<[^>]+>/g, '').replace('Xem thêm', '').trim();
            console.log(TruyengihotParser_1.decodeHTMLEntity(desc));
...
},{"./TruyengihotParser":56,"paperback-extensions-common":12}],56:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
