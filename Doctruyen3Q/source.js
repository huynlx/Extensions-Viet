...
class Doctruyen3Q extends paperback_extensions_common_1.Source {
    ...
    async getHomePageSections(sectionCallback) {
        ...
        for (const element of $('#home > .body > .main-left .item-manga > .item').toArray()) {
            ...
            let imageFinal = '';
            if ($('.image-item > a > img', element).hasAttr("data-original")) {
                imageFinal = $('.image-item > a > img', element).attr("data-original");
            }
            else {
                imageFinal = $('.image-item > a > img', element).attr('src');
            }
            ...
            newUpdatedItems.push(createMangaTile({
                ...
                image: imageFinal !== null && imageFinal !== void 0 ? imageFinal : "",
                title: createIconText({ text: title }),
...
},{"./Doctruyen3QParser":56,"paperback-extensions-common":12}],56:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
