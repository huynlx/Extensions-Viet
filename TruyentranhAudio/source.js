...
class TruyentranhAudio extends paperback_extensions_common_1.Source {
    ...
    getChapters(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
                url: 'https://lxhentai.com/story/view.php?id=1208&token=MC40NDcwNTcwMzMwODU4Mzk0NAvvMC4yNTY3OTQ3MTIyODY0OTc1Mwvv',
                method,
            });
    ...
    getHomePageSections(sectionCallback) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //New Added
            request = createRequestObject({
                url: 'https://lxhentai.com/story/cat.php?id=87&token=MC43MDY1OTM3MDc1ODgxMjA4MC4xMTQ5MjM1OTA5MjQ2NzU5Nwvv',
                method: "GET",
            });
            let newAddItems = [];
            data = yield this.requestManager.schedule(request, 1);
