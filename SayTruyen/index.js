...
class SayTruyen extends paperback_extensions_common_1.Source {
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = createRequestObject({
                url: query.title ? encodeURI(DOMAIN + `danh-sach-truyen.html?name=${query.title}`) :
                    (tags[0] === 'all' ? (DOMAIN + 'danh-sach-truyen.html?') : encodeURI(`${DOMAIN}danh-sach-truyen.html?status=0&name=&genre=${tags[0]}&sort=last_update`)),
                method: "GET",
...
},{"./SayTruyenParser":56,"paperback-extensions-common":12}],56:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
