...
class Truyentranh24h extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        let data = await this.requestManager.schedule(request, 1);
        let $ = this.cheerio.load(data.data);
        let manga = Truyentranh24hParser_1.parseViewMore($);
        metadata = !Truyentranh24hParser_1.isLastPage($) ? { page: page + 1 } : undefined;
    ...
    async getSearchResults(query, metadata) {
        ...
        let data = await this.requestManager.schedule(request, 1);
        let $ = this.cheerio.load(data.data);
        const tiles = Truyentranh24hParser_1.parseSearch($);
        metadata = !Truyentranh24hParser_1.isLastPage($) ? { page: page + 1 } : undefined;
        return createPagedResults({
            results: tiles,
            metadata
...
exports.Truyentranh24h = Truyentranh24h;

},{"./Truyentranh24hParser":56,"paperback-extensions-common":12}],56:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
