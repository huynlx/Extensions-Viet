    ...
    getHomePageSections(sectionCallback) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let obj of $('.c-tabs-item__content', '.tab-content-wrap').toArray()) {
                let title = $(`.post-title > h3 > a`, obj).text().trim();
                let subtitle = $(`.chapter > a`, obj).text().trim();
                const image = (_m = $('.c-image-hover > a > img', obj).attr('data-src')) !== null && _m !== void 0 ? _m : "";
...
},{"./HentaiCubeParser":56,"paperback-extensions-common":12}],56:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.convertTime = exports.isLastPage = exports.parseViewMore = exports.parseSearch = exports.generateSearch = exports.capitalizeFirstLetter = void 0;
