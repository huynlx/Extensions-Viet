...
import { TruyentranhAudio } from '../TruyentranhAudio/TruyentranhAudio'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('TruyentranhAudio Tests', () => {
    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new TruyentranhAudio(cheerio)
     ...
     */
    const mangaId = 'truyen-vo-luyen-dinh-phong.html' 
