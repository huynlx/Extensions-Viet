...
},{"./NetTruyenParser":58,"paperback-extensions-common":12}],58:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Parser = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const BaotangtruyentranhParser_1 = require("../Baotangtruyentranh/BaotangtruyentranhParser");
class Parser {
    convertTime(timeAgo) {
        var _a;
        let time;
    ...
    parseTags($) {
        ...
        genreTags.push(createTag({ id: "all", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Tất cả") }));
        ...
        $("#ctl00_divRight .genres ul.nav li a").each((_, element) => {
            ...
            const label = BaotangtruyentranhParser_1.decodeHTMLEntity(rawLabel);
            ...
            if (href.includes("/tim-truyen/")) {
                id = (_c = (_b = (_a = href.split("/tim-truyen/").pop()) === null || _a === void 0 ? void 0 : _a.split("/")[0]) === null || _b === void 0 ? void 0 : _b.split("?")[0]) !== null && _c !== void 0 ? _c : "";
            }
            else if (href.includes("/tag/")) {
                const tagSlug = (_f = (_e = (_d = href.split("/tag/").pop()) === null || _d === void 0 ? void 0 : _d.split("/")[0]) === null || _e === void 0 ? void 0 : _e.split("?")[0]) !== null && _f !== void 0 ? _f : "";
                if (tagSlug) {
                    id = `tag/${tagSlug}`;
                }
            }
            if (id && label) {
                genreTags.push(createTag({ id: id, label: label }));
            }
        });
        // 3. Trạng thái (Status)
        const statusOptions = [
            { id: "status=", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Tất cả") },
            { id: "status=2", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Hoàn thành") },
            { id: "status=1", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Đang tiến hành") },
        ];
        for (const option of statusOptions) {
            statusTags.push(createTag({ id: option.id, label: option.label }));
        }
        // 4. Xếp hạng (Sort Options)
        const sortOptions = [
            { id: "sort=15", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Truyện mới") },
            { id: "sort=10", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Top all") },
            { id: "sort=11", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Top tháng") },
            { id: "sort=12", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Top tuần") },
            { id: "sort=13", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Top ngày") },
            { id: "sort=20", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Theo dõi nhiều") },
            { id: "sort=25", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Bình luận nhiều") },
            { id: "sort=30", label: BaotangtruyentranhParser_1.decodeHTMLEntity("Số chapter") },
        ];
        for (const option of sortOptions) {
            sortTags.push(createTag({ id: option.id, label: option.label }));
        }
        return [
            createTagSection({
                id: "genres",
                label: BaotangtruyentranhParser_1.decodeHTMLEntity("Thể loại"),
                tags: genreTags,
            }),
            createTagSection({
                id: "status",
                label: BaotangtruyentranhParser_1.decodeHTMLEntity("Trạng thái"),
                tags: statusTags,
            }),
            createTagSection({
                id: "sort",
                label: BaotangtruyentranhParser_1.decodeHTMLEntity("Xếp hạng"),
                tags: sortTags,
            }),
        ];
    }
...
},{"../Baotangtruyentranh/BaotangtruyentranhParser":56,"paperback-extensions-common":12}]},{},[57])(57)
});
