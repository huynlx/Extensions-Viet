        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = createRequestObject({
                url: genres.length === 1 && !query.title
                    ...
                    : `${url}/tim-truyen`,
                method: "GET",
                param: encodeURI(`?keyword=${(_d = query.title) !== null && _d !== void 0 ? _d : ""}&genres=${genres.join(",")}&page=${page}`),
            });
            const data = yield this.requestManager.schedule(request, 1);
            let $ = this.cheerio.load(data.data);
...
},{"./NetTruyenParser":57,"paperback-extensions-common":12}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.decodeHTMLEntity = exports.Parser = void 0;
